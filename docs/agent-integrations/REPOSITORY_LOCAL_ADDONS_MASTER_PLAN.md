# Repository-Local Add-ons Master Plan — DEPRECATED_sys-monitor-tauri

## Status

**PLANNING ONLY / IMPLEMENT IN A LATER SESSION**

Target repository: `quantdale/DEPRECATED_sys-monitor-tauri`  
Planning branch: `plan/repo-local-addons-2026-08-28`

## Repository assessment

Deprecated/near-empty Tauri-era system-monitor predecessor.

**Decision:** `NO_ADDON_CHANGE_RECOMMENDED`

Preserve as historical material. Put new tooling in quantdale/monitorers.
...
- Any new MCP/plugin installation
- Migration work disguised as tooling setup
